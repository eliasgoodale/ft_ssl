...
/*   Updated: 2018/07/13 13:35:09 by egoodale         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
enum {
    SUCCESS = 0,
    _NULL,            /* Null pointer parameter */
    EINPUTOOLONG,    /* input data too long */
    ESTATE,      /* called Input after FinalBits or Result */
    EBADPARAM         /* passed a bad parameter */
};
