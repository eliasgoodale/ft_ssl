...
/*   Updated: 2018/06/24 17:02:17 by egoodale         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../inc/md5.h"
#include "../inc/md5_hash.h"
...
void	md5_hh(uint32_t mstate[4], uint32_t x[16])
{
	VAR(unsigned, i, -1);
	while(++i < 16)
	{
...
void	md5_ii(uint32_t mstate[4], uint32_t x[16])
{
	VAR(unsigned, i, -1);
	while(++i < 16)
	{
